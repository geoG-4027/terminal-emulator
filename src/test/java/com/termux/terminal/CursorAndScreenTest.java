...
public class CursorAndScreenTest extends TerminalTestCase {
	...
	public void testDeleteLinesKeepsStyles() {
		...
		// "${CSI}H" - place cursor at 1,1, then "${CSI}2M" to delete two rows.
		...
		// Set default fg and background for the new blank rows:
		enterString("\033[38;5;98m");
		enterString("\033[48;5;99m");
		// "${CSI}B" to go down one line, then "${CSI}2L" to insert two rows:
